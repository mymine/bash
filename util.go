...
func (d *BaiduNetdisk) linkOfficial(file model.Obj, args model.LinkArgs) (*model.Link, error) {
	...
	res, err := base.NoRedirectClient.R().SetHeader("User-Agent", "netdisk;11.38.2;android-android;12;JSbridge4.4.0;jointBridge;1.1.0;").Head(u)
	if err != nil {
		return nil, err
	}
	...
	return &model.Link{
		URL: u,
		Header: http.Header{
			"User-Agent": []string{"netdisk;11.38.2;android-android;12;JSbridge4.4.0;jointBridge;1.1.0;"},
		},
	}, nil
}
